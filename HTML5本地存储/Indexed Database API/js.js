...
window.onload = function() 
{
	...
	var checkAll = document.getElementsByName("checkAll")[0]; //全选

	var btnDelete = document.getElementsByName("delete")[0]; //删除选中

	var btnClear = document.getElementsByName("clear")[0]; //删除数据库
	...
	btnDelete.addEventListener("click", function(event) 
	{
		...
		var transaction = null , objectStore = null , request = null;
